...
class Module:
    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        """Invoke the forward method of the module when the module is called.

        This function allows instances of `Module` to be used as if they were functions.
        It passes all arguments to the `forward` method, which must be defined in any
        subclass of `Module`.
